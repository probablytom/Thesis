...
To answer this question, a model of play is produced, and aspects developed
which encapsulate different play styles so as to compare empirically sourced
datasets against both its aspect-augmented and unaltered counterparts. The
following subsections detail the naive model developed and aspects applied to
this model.
...
\inline{Explain the diagram in prose.}
...
\labelledsubsec{Simple Model of Learning}{optimisation_with_aspects_basiclearningaspect}
...
\labelledsubsec{Modelling Bias with Hyperbolic Decay}{optimisation_with_aspects_hyperbolicdecay}

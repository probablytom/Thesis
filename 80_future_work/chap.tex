...
% below, so maybe this section isn't required.
...
Relatedly, the dataset presents opportunities for resesarch in aspectually
augmented simulation \& modelling. A research question presents itself related
to the future work described in \cref{future_work_feature_discovery} related to
the discovery of system features:

\begin{researchquestion}
    Can an aspectually augmented model be trained to identify features of
    RPGLite play in an explainable manner?
\end{researchquestion}

...
\begin{researchquestion}
  \begin{description}
\item[RQ1] \rqtwo{} \laurie{i must admit that i don't have an intuition of what `advice-based' might mean, and a quick grep through the PDF didn't turn up a definition. in sec 1.2.1, `advice' is defined as `aspect + join point', but i'm not sure what's different between `AOP' and `advice-based'. they feel like synonyms?}
\item[RQ2] \rqthree{}
\item[RQ3] \rqfour{}
  \end{description}

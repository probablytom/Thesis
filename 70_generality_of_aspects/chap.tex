...
The accurate simulation of $frac{6}{21}$ players i.e. $\approx{}28.9\%$ of the sampled playerbase demonstrates two
...
to represent new behaviours within --- and add new parameters to --- an existing
model. This is demonstrated by the \aspectoriented addition of learning
behaviours --- and parameters controlling learning --- to the naive model of
RPGLite play.

...
function returned, then the returned function \inline{REWORK THIS PARA AND
FINISH DISCUSSING PDSF's ORIGINAL TECHNICAL DEFINITION. EVERYTHING BELOW THIS IS
FROM THE INITIAL DRAFT OF THE THESIS.}

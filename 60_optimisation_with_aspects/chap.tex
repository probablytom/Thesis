...
are:\inline{IIRC Tim doesn't love the description list formatting. Probably
...
\cref{subsec:exp1_model_parameters}. \inline{RETURN TO FINISH DISCUSSING PARAMS
USED BY BOREDOM MODEL AFTER WRITING ABOUT MODEL PARAMETERS}
...
described shortly. These parameters are\inline{RETURN TO COMPLETE AFTER WRITING
ABOUT ModelParams CLASS}:
\begin{itemize}

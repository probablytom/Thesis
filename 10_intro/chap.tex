...
\inline{
  TODO may no longer be true; reworked; re-examine this\ldots{}
  I worry that the explanation of aspect orientation and \sociotechnical
  systems repeats itself, and also repeats other parts of the introduction.
  I suspect a lot of what's here is redundant. Is the section needed at all?
}
...
principle\inline{Cite Robert Martin} suggests that software with multiple
...
\inline{
  The below have been moved around a lot, and I'm no longer sure this
  subsection makes sense. If it doesn't, move it. It's almost future work
  content. \emph{Maybe} it's a justification of the aspect-oriented approach, or
  \emph{maybe} it's a discussion of possible contributions, or \emph{maybe} it's
  worth nuking completely.
}
...
\begin{description}
  ...
  \item[Advice as Hypothesised System Behaviour] \inline{
      COME BACK TO THIS I'm not sure how to phrase having advice as a
      hypothesised system behaviour right now; moving on to keep momentum. Needs
      completing!
    }
\end{description}
...
\begin{description}
  ...
  \item[Investigation into Aspect Portability] We investigate whether
    ...
    \item[Exploration of Opportunities Enabled by Aspect-Oriented Modelling]
      \inline{Describe the future work section as its own contribution}
\end{description}
...
Later chapters explore the application of aspect-orientation of aspect-oriented
programming to simulation \& modelling codebases, using a model of RPGLite as an
example.
\inline{
  Chapter structure for experiments may be reworked; thesis
  structure concerning experimental chapters needs to be finished.
}

#!/bin/bash
# Taken from Matt Might: https://matt.might.net/articles/shell-scripts-for-passive-voice-weasel-words-duplicates
...
egrep -n -i --color "\\b(am|are|were|being|is|been|was|be)\\b[ ]*(\w+ed|($irregulars))\\b" $*

...
aspect-orientation is of particular relevance to this thesis in two regards.

First, this literature review discusses advancements in the field relevant to
...
\revnote{I would rephrase the opening of this as direct report of voice to make
  it more succinct. \cite{Constantinides04aopconsidered} offered an early
  critique of AOP, making unfavourable comparisons with criticisms of GOTO
  statements.}
...
\inline{Add subject-oriented programming here}
...
Indeed, the conclusion \citet{popovici2003JITaspects} provide indicates that
some performance issues may prevent dynamic aspect orientation from being useful
in production software, but that it presented opportunities in a prototyping or
debugging context.
...
is\revnote{Can you be more precise here? Is it the first instance?} presented by
...
aspect-oriented simulation of agent-based models\revnote{Don't think Swarm has
  been mentioned before so needs explanation/cite - sentence or two}.%
...
intrinsic component of the simulated system.\revnote{intrinsic? explicit?} They
...
from existing literature such as \cite{kiczales1997aspect}.\revnote{it seems
  like this might be an important exposition, so perhaps more details?} The fact
...
\revnote{This is waffly. Would suggest simplifying to something like ``The
  position adopted by Gulyas aligns with that taken in this thesis: that aspect
  orientation has signficant benefits for supporting software based modelling
  and simulation''}

...
\revnote{I \emph{definitely} need more reviews of specific tools here. AspectJ
  now has dynamic weaving, I'm certain, and if so it's essential it gets a spot
  here (before prose, really). Also, where's Nu?}

...
to this body of work~\inline{I assume we discuss PDSF existing in the intro}.
...
\begin{itemize}
    ...
    \item \inline{Write more PDSF opportunities}
\end{itemize}

\inline{Do we need a brief explainer of what aspect orientation is here?
Or will this go in the introduction? already a little in the earlier two subsections.}

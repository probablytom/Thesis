...
% \inline{Decide on section ordering}
% \inline{Longlist papers to be included from devonthink}
...
% kind of Hawthorne Effect\inline{does this need a citation?}, where the inclusion
...
% tools~\cite{DEVSaspectorientation2008aksu}~\inline{throw more in here from excel},
% or into existing ones~\cite{chibani2019using}\inline{throw more in here from
% excel}. \inline{Fill out more}
...
% \inline{Determine other sections that can be included here...!}
...
\inline{Some notes here on what this chapter contains, and a brief description of its
layout. Two snappy paras.}
...
\inline{Do we need a brief explainer of what aspect orientation is here? Or will this go in the introduction?}
...
tools~\cite{DEVSaspectorientation2008aksu}~\inline{throw more in here from excel},
or into existing ones~\cite{chibani2019using}\inline{throw more in here from
excel}. \inline{Rethink this. The angle is, ``much of the lit strays from any kind
...
\inline{This \emph{badly} needs revisiting.}
